...
// Reusable InfoItem component with left-aligned text
const InfoItem = ({ label, value }) => (
  <div className="flex flex-col items-start w-full space-y-1">
    <h3 className="text-xs md:text-sm font-medium text-light-text/70 dark:text-dark-text/70 text-left">{label}</h3>
    <p className="text-base md:text-lg font-semibold text-light-text dark:text-dark-text text-left">{value}</p>
  </div>
);
