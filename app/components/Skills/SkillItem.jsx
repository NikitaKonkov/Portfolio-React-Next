...
const SkillItem = ({ skill }) => {
  return (
    <div style={{ padding: '16px' }} className="w-[240px]">
      <div className="relative rounded-lg shadow-xl p-6 flex flex-col items-center transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl overflow-hidden bg-light-secondary/90 dark:bg-dark-secondary/90 border border-blue-500/20 hover:border-blue-500/50 h-full">
